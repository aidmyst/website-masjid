...
<nav class="bg-gray-800 sticky top-0 z-50 shadow-md" x-data="{ open: false }">
        ...
        <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="hidden md:flex md:items-center md:space-x-6">
                ...
                <x-nav-link :href="route('tentang')"
                    :active="request()->routeIs('tentang')">Tentang</x-nav-link>

                <x-nav-link :href="route('kajian')"
                    :active="request()->routeIs('kajian')">Kajian</x-nav-link>

                <x-nav-link :href="route('donasi')"
    ...
    <div x-show="open" @click.outside="open = false"
        ...
        class="md:hidden absolute w-full origin-top bg-gray-800 shadow-lg z-40"
        x-cloak>

        <div class="space-y-1 px-4 py-4">

            <x-nav-link-mobile :href="route('beranda')"
                :active="request()->routeIs('home') || request()->routeIs('beranda')">Beranda</x-nav-link-mobile>

            <x-nav-link-mobile :href="route('tentang')"
                :active="request()->routeIs('tentang')">Tentang</x-nav-link-mobile>

            <x-nav-link-mobile :href="route('kajian')"
                :active="request()->routeIs('kajian')">Kajian</x-nav-link-mobile>

            <x-nav-link-mobile :href="route('donasi')"
                :active="request()->routeIs('donasi')">Donasi</x-nav-link-mobile>
